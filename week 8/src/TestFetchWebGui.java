...
public class TestFetchWebGui {
  final static List<DownloadWorker> downloaders = new ArrayList<>();
  ...
  private static void goodFetch() {
    ...
    cancelButton.addActionListener(
      new ActionListener() {
        public void actionPerformed(ActionEvent e){
          for(DownloadWorker dw : downloaders){

            boolean couldCancel = dw.cancel(true);
            System.out.println(dw.url + " cancelled: " + couldCancel);
          }
        }
      });
  ...
  static class DownloadWorker extends SwingWorker<String,String> {
    ...
    public void done() {
      ...
      } catch (InterruptedException exn) { System.out.println("Interrupted");}
